<?php
    ...
    checkstatus2($_SESSION['IsOnline']);
     ...
     if(isset($_POST['val'])) 
     {
        ...
        $idreciver = 6;
        $transaction = "Recharge abonment jawaz";
        $mnt = $_POST['montant'];
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="page-header" id="top">
                                    <h2 class="pageheader-title">RECHARGE ABONMENT JAWAZ</h2>
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="">
                                            <div class="form-group">
                                                <label for="inputText3" class="col-form-label">N Abonment Jawaz</label>
