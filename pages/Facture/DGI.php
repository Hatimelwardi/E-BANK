...
<head>
    ...
    <title>DIRECTION GENERAL DES IMPOTS</title>
    <!-- Bootstrap CSS -->
    <style>
           .div2{
        }
                    ...
                    <div class="col-xl-10">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="page-header" id="top">
                                    <h2 class="pageheader-title">Paiment IR, IS, TVA ET TIMBRE FISCAL</h2>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="card">
<!--                                    <h5 class="card-header">Basic Form</h5> TAXES, AMENDES, DOUANES ET IMPÔTS INDIRECTS
-->
                                    <div class="card-body">
                                        <form method="post" action="">
                                            <div class="form-group">
                                                <label for="inputText3" class="col-form-label">Reference de paiment</label>
