...
<head>
    ...
    <title>TRESORERIE GENERALE DU ROYAUME</title>
    <!-- Bootstrap CSS -->
    <style>
           .div2{
        }
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="page-header" id="top">
                                    <h2 class="pageheader-title">PAIMENT TAXES, AMENDES, DOUANES ET IMPÔTS INDIRECTS</h2>
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="">
                                            <div class="form-group">
                                                <label for="inputText3" class="col-form-label">Reference de l'avis</label>
